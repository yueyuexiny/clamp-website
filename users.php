...
<div class="container page-container">
    ...
    <div class="col-md-5 col-sm-5 col-xs-5">  		
  		...
  		<div class="col-md-1 col-sm-1 col-xs-1"><button type="button" style="padding: 2% 0;" class="btn btn-lg btn-primary btn-block disabled"> <span style="font-size:30px;color:black;"> from </span></button></div> 
  		<div class="col-md-5 col-sm-5 col-xs-5"> 
