...
<div class="container page-container">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">  		
  		<button type="button" class="btn btn-lg btn-primary btn-block" disabled> <?php echo $userCount;?> Requests</button>
  		</div>
  		<div class="col-md-6 col-sm-6 col-xs-6"> 
  		<button type="button" class="btn btn-lg btn-primary btn-block" disabled> <?php echo $organizationCount;?> Organizations</button>
  		</div>
