...
<div class="container page-container">
    ...
    <div class="col-md-5 col-sm-5 col-xs-5">  		
  		...
  		<div class="col-md-2 col-sm-2 col-xs-2"> <button type="button" style="padding: 2% 0;" class="btn btn-lg btn-primary btn-block active" role="button" aria-pressed="true"><span style="font-size:30px;"> <i>from</i> </span></button></div>
