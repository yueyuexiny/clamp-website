...
<div class="container page-container">
    ...
    <p>These are some of the CLAMP users actively using CLAMP for their NLP and Machine Learning tasks.</p>
    ...
    <div id="customers-logo" class="row">
        ...
        <div class="col-md-6 col-sm-6">
            <img src="img/clients/UTH-SBMI.jpg" alt="University of Texas Health Science Center School of Biomedical Informatics." class="thumbnail"/>
        </div>
    </div>
    <div id="customers-logo" class="row">
        <div class="col-md-6 col-sm-6">
    ...
    <div id="customers-logo" class="row">
        <div class="col-md-6 col-sm-6">
            <img src="img/clients/BERGAnalytics.png" alt="BERG Analytics" class="thumbnail"/>
        </div>
        <div class="col-md-6 col-sm-6">
    ...
    <div id="customers-logo" class="row">
        <div class="col-md-6 col-sm-6">
            <img src="img/clients/StanfordUniversityNLPGroup.jpg" alt="Stanford University NLP Group" class="thumbnail"/>
        </div>
        <div class="col-md-6 col-sm-6">
            <img src="img/clients/UniversityOfMichigan.jpg" alt="University Of Michigan" class="thumbnail"/>
        </div>
