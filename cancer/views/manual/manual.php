                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"  style="text-align: left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                                </span>NLP COMPONENTS <i class="glyphicon glyphicon-triangle-bottom"></i></a>
                        </h4>
                    </div>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"  style="text-align: left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">
                                </span>MACHINE LEARNING COMPONENTS<i class="glyphicon glyphicon-triangle-bottom"></i></a>
                        </h4>
                    </div>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"  style="text-align: left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">
                                </span>BUILD A PIPELINE <i class="glyphicon glyphicon-triangle-bottom"></i></a>
                        </h4>
                    </div>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"  style="text-align: left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">
                                </span>ANNOTATION <i class="glyphicon glyphicon-triangle-bottom"></i></a>
                        </h4>
                    </div>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"  style="text-align: left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse6">
                                </span>MACHINE LEARNING MODEL DEVELOPMENT <i class="glyphicon glyphicon-triangle-bottom"></i></a>
                        </h4>
                    </div>
